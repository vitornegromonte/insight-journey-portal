...
const Papers = () => {
  ...
  const papers = [
    ...
    },
    {
      ...
      authors: "Danilo Monteiro Ribeiro, Felipe Vasconcelos Melo, Vitor Negromonte, Gabriel Walisson Matias, Adna Farias, Celeste Azul, Ana Paula Chaves, Kiev Gama.",
      ...
      <section className="pt-32 pb-16 px-4">
        <div className="container mx-auto text-center">
          ...
          <p className="text-muted-foreground max-w-2xl mx-auto">
            My published research in machine learning, computer vision, and
            computational creativity, along with presentations and invited
                        ...
                        <div className="flex flex-col md:flex-row gap-6">
                          ...
                          <div className="flex-1">
                            ...
                            <div className="mt-4 flex space-x-4">
                              <a href={talk.videoUrl} className="text-accent">
                                Watch
                              </a>
                              <a href={talk.slidesUrl} className="text-accent">
                                Slides
                              </a>
                            </div>
                          </div>
